...
class FusionNet(nn.Module):
    ...
    def forward(self,mesh_list,body_list,hand_list):
        a=self.layer_1(torch.cat([mesh_list[0],body_list[0],hand_list[0]],dim=1))
        b=self.layer_2(torch.cat([mesh_list[1],body_list[1],hand_list[1]],dim=1))
        c=self.layer_3(torch.cat([mesh_list[2],body_list[2],hand_list[2]],dim=1))
        d=self.layer_4(torch.cat([mesh_list[3],body_list[3],hand_list[3]],dim=1))
        e=self.layer_5(torch.cat([mesh_list[4],body_list[4],hand_list[4]],dim=1))
        return [a,b,c,d,e]

...
class PoseGuider(nn.Module):
    ...
    def forward(
        ...
        cond = torch.cat((face,keypoint), dim=1)
...
def get_poseguider(image_finetune=False,num_conds=2,cfg_path="/home/shipu/mycode/redance/config.yaml"):
    """
...
if __name__=="__main__":
    ...
    pose_guider=get_poseguider(image_finetune=False,num_conds=2).to("cuda")
    # print(pose_guider)

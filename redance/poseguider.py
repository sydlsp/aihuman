...
def get_poseguider(image_finetune=False,num_conds=3,cfg_path="/home/shipu/mycode/redance/config.yaml"):
    """
...
if __name__=="__main__":
    ...
    pose_guider=get_poseguider(image_finetune=True,num_conds=3).to("cuda")
    print(pose_guider)
    ...
    result=pose_guider(face,body,hand)

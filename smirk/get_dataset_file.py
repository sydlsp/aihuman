import os
import cv2
from detect_mesh_and_keypoint import DetectMeshandKeypoint

"""
使用我们自己写的DetectMeshandKeypoint类来创建数据集
"""
...
dataset_dir_path="/remote-home/share/yfsong/shipu/dataset_video_true"  # 要创建文件夹的路径
...
print(data_dir_part_list[:20])

# for dir in data_dir_part_list[:20]:
#
#     print(dir)

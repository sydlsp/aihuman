...
class FLAME(nn.Module):
    ...
    def __init__(self, flame_model_path='assets/FLAME2020/generic_model.pkl', 
        ...
        self.register_buffer('l_eyelid', torch.from_numpy(np.load(f'/data/shipu/smirk/assets/l_eyelid.npy')).to(self.dtype)[None])
        self.register_buffer('r_eyelid', torch.from_numpy(np.load(f'/data/shipu/smirk/assets/r_eyelid.npy')).to(self.dtype)[None])
        ...
        lmk_embeddings_mp = np.load("/data/shipu/smirk/assets/mediapipe_landmark_embedding/mediapipe_landmark_embedding.npz")

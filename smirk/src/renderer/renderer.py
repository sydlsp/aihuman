...
class Renderer(nn.Module):
    def __init__(self, render_full_head=False, obj_filename='/data/shipu/smirk/assets/head_template.obj'):
        ...
        flame_masks = pickle.load(
            open('/data/shipu/smirk/assets/FLAME_masks/FLAME_masks.pkl', 'rb'),  # 这里真有毒，用之前的pkl文件就行
            encoding='latin1')

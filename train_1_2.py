    ...
    for epoch in range (first_epoch,num_train_epochs):
        ...
        for step,batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(net):
                ...
                model_pred=net(noisy_latents,timesteps,ref_img_latents,image_prompt_embeds,ref_img_mesh,ref_img_keypoint,pose_img_mesh,pose_img_keypoint)# 这里先欠着，后来检查的时候这里应该是少了一个uncond的参数
...
# accelerate launch --config_file /remote-home/yfsong/shipu/mycode/one_gpu_default_config.yaml train_1_2.py

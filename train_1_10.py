        ...
        for step,batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(net):
                ...
                with torch.no_grad():
                    ...
                    clip_img_embeds=image_enc(clip_img.to(device=accelerator.device,dtype=weight_dtype)).image_embeds
...
# CUDA_VISIBLE_DEVICES=6,7 accelerate launch --config_file /home/shipu/mycode/default_config.yaml train_1_10.py
# CUDA_VISIBLE_DEVICES=5 accelerate launch --config_file  /home/shipu/mycode/one_gpu_default_config.yaml train_1_9.py

...
from dataset_related.dataset_write_6 import MyDataset,collate_fn # 这里别忘记改了
"""
...
def main(cfg):
    ...
    pose_guider=get_poseguider(image_finetune=True,num_conds=3).to(device=accelerator.device)  # 第一阶段image_finetune为true
    ...
    for epoch in range (first_epoch,num_train_epochs):
        ...
        for step,batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(net):
                ...
                pose_image_hdkp=pose_image_hdkp.unsqueeze(2)  # 新增的手部mesh
                ...
                model_pred=net(noisy_latents,timesteps,ref_img_latents,image_prompt_embeds,pose_img_mesh,pose_img_keypoint,pose_image_hdkp)# 这里先欠着，后来检查的时候这里应该是少了一个uncond的参数
...
# CUDA_VISIBLE_DEVICES=5,6,7 accelerate launch --config_file /home/shipu/mycode/default_config.yaml train_1_16.py

...
from train_1_10 import Net,FusionNet   # 修改一下Net的来源
...
ckpt_path="/data/shipu/ani_train_ckpt/stage1_7/checkpoint-100000/pytorch_model.bin"
...
pose_dir="/data/shipu/data/shipu/dataset_true/videos/video_200_high_quanlity_clip_24"
...
# 准备好ref_img的相关图片
ref_frame_path="/data/shipu/data/shipu/dataset_true/videos/video_200_high_quanlity_clip_24/video_200_high_quanlity_clip_24_frame_0000.jpg"
ref_mesh_path="/data/shipu/data/shipu/dataset_true/videos/video_200_high_quanlity_clip_24/video_200_high_quanlity_clip_24_mesh_0000.jpg"
ref_keypoint_path="/data/shipu/data/shipu/dataset_true/videos/video_200_high_quanlity_clip_24/video_200_high_quanlity_clip_24_keypoint_0000.jpg"
ref_hand_path="/data/shipu/data/shipu/dataset_true/videos/video_200_high_quanlity_clip_24/video_200_high_quanlity_clip_24_hands_0000.jpg"  # 这里补上hands的路径
...
# for i in range(92,102):
    ...
    image=pipeline(ref_image=ref_frame_pil,pose_mesh=pose_mesh_pil,pose_keypoint=pose_keypoint_pil,pose_hand=pose_hand_pil,ref_mesh=ref_mesh_pil,ref_keypoint=ref_keypoint_pil,ref_hand=ref_hand_pil,width=cfg.data.sample_size[0],height=cfg.data.sample_size[1],num_inference_steps=100,guidance_scale=2,generator=generator).images
    image = image[0, :, 0].permute(1, 2, 0).cpu().numpy()  # (3, h, w)
    res_image_pil = Image.fromarray((image * 255).astype(np.uint8))
    res_image_pil.save(f"/home/shipu/mycode/output/save_28/res_image_{i}.jpg")

...
if __name__=="__main__":
    ...
    # /data/shipu/train_data_full/train_data_hdkp/videos/video_228_high_quanlity_clip_39/video_228_high_quanlity_clip_39_frame_0000.jpg
    ...
    pose_folder_path="/data/shipu/train_data_full/train_data_hdkp/videos/video_3_high_quanlity_clip_84" # 动作文件夹的路径

    pose_mesh_list=[file for file in os.listdir(pose_folder_path) if "mesh" in file]
    ...
    """
     def __call__(self,ref_image,pose_mesh,pose_keypoint,pose_hands,pose_hdkp,
                 ...
                 **kwargs):
    """
    pipeline_output=pipeline(ref_image_pil,mesh_list,keypoint_list,hands_list,hdkp_list,width,height,video_length,50,2.0,generator=generator)

    video=pipeline_output.videos

    output_path="/home/shipu/mycode/video_output/video_20250529_1.mp4"
    save_videos_grid(video,output_path,n_rows=1,fps=8)


# CUDA_VISIBLE_DEVICES=4 python pose2videopipeline_17.py

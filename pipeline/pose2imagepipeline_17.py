...
ckpt_path="/data/shipu/ani_train_ckpt/stage1_4cond_full/checkpoint-200000/pytorch_model.bin"
...
pose_dir="/data/shipu/train_data_full/train_data_hdkp/videos/video_153_high_quanlity_clip_1"
...
# 准备好ref_img的相关图片
ref_frame_path="/data/shipu/train_data_full/train_data_hdkp/videos/video_153_high_quanlity_clip_66/video_153_high_quanlity_clip_66_frame_0000.jpg"
...
# for i in range(92,102):
    ...
    save_dir = "/home/shipu/mycode/output/save_153"
    os.makedirs(save_dir, exist_ok=True)
    res_image_pil.save(os.path.join(save_dir, f"res_image_{i}.jpg"))
    print(f"save image {i}")


# CUDA_VISIBLE_DEVICES=4 python pose2imagepipeline_17.py

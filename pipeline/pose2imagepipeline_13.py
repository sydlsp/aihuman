...
from train_1_13 import Net   # 修改一下Net的来源
...
device="cuda"
# 先把要用的基础模型加进来
cfg=OmegaConf.load("/home/shipu/mycode/train_config/train_1_high.yaml")
# 初始化VAE
...
ckpt_path="/data/shipu/ani_train_ckpt/stage1_high_dataset5/checkpoint-200000/pytorch_model.bin"
...
pose_dir="/data/shipu/train_data/data/shipu/dataset_true/videos/video_198_high_quanlity_clip_49"
...
# 准备好ref_img的相关图片
ref_frame_path="/data/shipu/train_data/data/shipu/dataset_true/videos/video_198_high_quanlity_clip_49/video_198_high_quanlity_clip_49_frame_0000.jpg"
...
# for i in range(6,15):
    ...
    save_dir="/home/shipu/mycode/output/save_54"

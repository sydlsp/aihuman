...
ckpt_path="/data/shipu/ani_train_ckpt/exp_2_stage1/checkpoint-200000/pytorch_model.bin"
...
pose_hand_list=[i for i in os.listdir(pose_dir) if "hdkp" in i]
...
# for i in range(6,15):
    ...
    save_dir="/home/shipu/mycode/output/save_126"

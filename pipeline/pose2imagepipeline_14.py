...
from redance.src.models.hack_unet3d import HackUNet3DConditionModel
from redance.poseguider import get_poseguider
from train_1_14 import Net   # 修改一下Net的来源
    ...
    def __call__(self,
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i,t in enumerate(timesteps):
                ...
                noise_pred=self.denoising_unet(latent_model_input,t,encoder_hidden_states=image_prompt_embeds,latent_pose=pose_fea,return_dict=False)[0]
...
device="cuda"
# 先把要用的基础模型加进来
cfg=OmegaConf.load("/home/shipu/mycode/train_config/train_1_test.yaml")
# 初始化VAE
...
#初始化denoising_unet
denoising_unet=HackUNet3DConditionModel.from_pretrained_2d("/data/shipu/redance_weight/rv-5-1",subfolder="unet",
                                                               unet_additional_kwargs={"use_motion_module": False,"unet_use_temporal_attention": False,"unet_use_cross_frame_attention": False,}).to(device=device)
...
ckpt_path="/data/shipu/ani_train_ckpt/stage1_test/checkpoint-136000/pytorch_model.bin"
...
# for i in range(92,102):
    ...
    save_dir = "/home/shipu/mycode/output/save_30"

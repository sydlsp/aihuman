...
from train_1_16 import Net   # 修改一下Net的来源
...
ckpt_path="/data/shipu/ani_train_ckpt/stage1_3cond_hdkp/checkpoint-200000/pytorch_model.bin"
...
pose_dir="/data/shipu/train_data_hdkp/videos/video_44_high_quanlity_clip_24"
# /data/shipu/train_data_hdkp/videos/video_194_high_quanlity_clip_9/video_194_high_quanlity_clip_9_frame_0000.jpg"
...
pose_hand_list=[i for i in os.listdir(pose_dir) if "_hdkp_" in i]
...
# 准备好ref_img的相关图片
ref_frame_path="/data/shipu/train_data_hdkp/videos/video_44_high_quanlity_clip_24/video_44_high_quanlity_clip_24_frame_0000.jpg"
# /data/shipu/train_data_hdkp/videos/video_194_high_quanlity_clip_9/video_194_high_quanlity_clip_9_frame_0000.jpg"

# /data/shipu/train_data_hdkp/videos/video_116_high_quanlity_clip_15/video_116_high_quanlity_clip_15_frame_0000.jpg  效果可以

# /data/shipu/train_data_hdkp/videos/video_192_high_quanlity_clip_47/video_192_high_quanlity_clip_47_frame_0000.jpg

# /data/shipu/train_data_hdkp/videos/video_193_high_quanlity_clip_84/video_193_high_quanlity_clip_84_frame_0000.jpg  待测
# /data/shipu/train_data_hdkp/videos/video_194_high_quanlity_clip_9/video_194_high_quanlity_clip_9_frame_0000.jpg 待测
# /data/shipu/train_data_hdkp/videos/video_44_high_quanlity_clip_24/video_44_high_quanlity_clip_24_frame_0000.jpg 待测
...
for i in range(0,min(100,len(pose_mesh_list))):
# for i in range(6,15):
    # pose
    ...
    save_dir="/home/shipu/mycode/output/save_86"
    os.makedirs(save_dir,exist_ok=True)
    res_image_pil.save(os.path.join(save_dir,f"res_image_{i}.jpg"))
    print(f"save image {i}")


# CUDA_VISIBLE_DEVICES=4 python pose2imagepipeline_16.py

...
ckpt_path="/remote-home/share/yfsong/shipu/test_output/stage1_5/checkpoint-100000/pytorch_model.bin"
...
pose_dir="/remote-home/share/yfsong/shipu/dataset_video_true/shengyu/video_8_high_quanlity_clip_38"

pose_frame_list=[i for i in os.listdir(pose_dir) if "frame" in i]
...
pose_frame_list=sorted(pose_frame_list,key=extract_number)
pose_keypoint_list=sorted(pose_keypoint_list,key=extract_number)
pose_mesh_list=sorted(pose_mesh_list,key=extract_number)

# 准备好ref_img的相关图片
ref_frame_path="/remote-home/share/yfsong/shipu/dataset_video_true/shengyu/video_2_high_quanlity_clip_90/video_2_high_quanlity_clip_90_frame_0000.jpg"
ref_mesh_path="/remote-home/share/yfsong/shipu/dataset_video_true/shengyu/video_2_high_quanlity_clip_90/video_2_high_quanlity_clip_90_mesh_0000.jpg"
ref_keypoint_path="/remote-home/share/yfsong/shipu/dataset_video_true/shengyu/video_2_high_quanlity_clip_90/video_2_high_quanlity_clip_90_keypoint_0000.jpg"
...
for i in range(len(pose_mesh_list)):
    ...
    image=pipeline(ref_image=ref_frame_pil,pose_mesh=pose_mesh_pil,pose_keypoint=pose_keypoint_pil,ref_mesh=ref_mesh_pil,ref_keypoint=ref_keypoint_pil,width=cfg.data.sample_size[0],height=cfg.data.sample_size[1],num_inference_steps=250,guidance_scale=3.5,generator=generator).images
    image = image[0, :, 0].permute(1, 2, 0).cpu().numpy()  # (3, h, w)
    res_image_pil = Image.fromarray((image * 255).astype(np.uint8))
    res_image_pil.save(f"/remote-home/yfsong/shipu/mycode/output/save_3/res_image_{i}.jpg")

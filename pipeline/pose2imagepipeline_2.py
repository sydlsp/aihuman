...
这个版本是mesh_fea+kp_fea=pose_fea的版本，也就是我们现行所需要的推理版本
"""
...
"""
不对，这里的人物的身份信息好像是反的，用错了，检查一下，你为什么会这样
"""

pose_dir="/remote-home/share/yfsong/shipu/dataset_video_true_2/videos/video_14_high_quanlity_clip_1"
...
for i in range(0,min(25,len(pose_mesh_list))):
    ...
    res_image_pil.save(f"/remote-home/yfsong/shipu/mycode/output/save_17/res_image_{i}.jpg")

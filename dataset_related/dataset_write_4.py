...
"""
基于dataset_write修改而来，其实就是加的手部大的mesh图进行控制
"""
class MyDataset(Dataset):
    ...
    def get_batch_wo_pose(self,index):
        ...
        hands_list=self.sort_file_list([file for file in video_file if "_hands_" in file]) # 所有的hand图片，这里是由于我们之前文件的命名问题加一个下划线分开
        ...
        return pixel_values,pixel_values_mesh,pixel_values_keypoint,pixel_values_hands,clip_ref_image,pixel_values_ref_img,pixel_values_ref_mesh,pixel_values_ref_keypoint,pixel_values_ref_hands
    ...
    def __getitem__(self, item):
        """"""
        pixel_values, pixel_values_mesh, pixel_values_keypoint,pixel_values_hands,clip_ref_image, pixel_values_ref_img, pixel_values_ref_mesh, pixel_values_ref_keypoint,pixel_values_ref_hands = self.get_batch_wo_pose(
            item)
        ...
        sample = dict(
            ...
            pixel_values_hands=pixel_values_hands,  # 视频帧手部关键点

...
from dataset_related.dataset_write_5 import MyDataset,collate_fn # 这里别忘记改了
"""
    ...
    for epoch in range (first_epoch,num_train_epochs):
        ...
        for step,batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(net):
                ...
                model_pred=net(noisy_latents,timesteps,ref_img_latents,image_prompt_embeds,pose_img_mesh,pose_img_keypoint,pose_image_hands)# 这里先欠着，后来检查的时候这里应该是少了一个uncond的参数
...
if __name__ =="__main__":
    ...
    parser.add_argument("--config",type=str,default="/home/shipu/mycode/train_config/train_1_high.yaml")
...
# CUDA_VISIBLE_DEVICES=4,5,6,7 accelerate launch --config_file /home/shipu/mycode/default_config.yaml train_1_13.py

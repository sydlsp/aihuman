...
from my_module.new_poseguider import new_poseguider,new_poseguider_1,new_poseguider_2,new_poseguider_3
from dataset_related.dataset_write import MyDataset,collate_fn
"""
...
class Net(nn.Module):
    ...
    def forward(self,
        ...
        pose_fea=self.pose_guider(ref_mesh_tensor,ref_keypoint_tensor,pose_mesh_tensor,pose_keypoint_tensor)
...
def main(cfg):
    ...
    pose_guider=new_poseguider_3().to(device="cuda")
    ...
    for epoch in range (first_epoch,num_train_epochs):
        ...
        for step,batch in enumerate(train_dataloader):
            with accelerator.accumulate(net):
                ...
                model_pred=net(noisy_latents,timesteps,ref_img_latents,image_prompt_embeds,ref_img_mesh,ref_img_keypoint,pose_img_mesh,pose_img_keypoint)# 这里先欠着
...
# accelerate launch --config_file /remote-home/yfsong/shipu/mycode/one_gpu_default_config.yaml train_1_1.py

...
from my_module.new_poseguider import new_poseguider,new_poseguider_1,new_poseguider_2
...
def main(cfg):
    ...
    pose_guider=new_poseguider_2().to(device="cuda")
...
# accelerate launch --config_file /remote-home/yfsong/shipu/mycode/one_gpu_default_config.yaml train_1.py
